...
|  |担当 その1 |担当 その2  |
|---|---|---|
|0. Prerequisites  |  | 永田　識 |
|1. Quantum States and Qubits  |  |  |
|2. Single Qubits and Multi-Qubits gates + Problems  |髙松 洋亘さん |  |
|3. Quantum Algorithms   | 中島 慶祐 |  |
|4. Quantum Algorithms for Applications   | 天野 武彦(ibmamnt) |  |
